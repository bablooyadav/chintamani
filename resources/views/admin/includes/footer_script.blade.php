...
<script type="text/javascript" src="{{asset('assets/files/bower_components/owl.carousel/dist/owl.carousel.min.js')}}"></script>
<script type="text/javascript" src="{{asset('assets/files/assets/js/owl-custom.js')}}"></script>
...
<script type="text/javascript" src="{{asset('assets/files/bower_components/switchery/dist/switchery.min.js')}}"></script>
<script type="text/javascript" src="{{asset('assets/files/assets/pages/advance-elements/swithces.js')}}"></script>
<script src="{{asset('assets/files/assets/pages/wysiwyg-editor/wysiwyg-editor.js')}}"></script>
<script type="text/javascript" src="{{asset('assets/files/assets/js/modal.js')}}"></script>
<script type="text/javascript" src="{{asset('assets/files/assets/js/modalEffects.js')}}"></script>
